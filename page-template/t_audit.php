...
<section class="hero-sb-audit common-hero hero-bg <?php echo esc_attr($sec_class); ?>">
    <div class="container">
        ...
        <div class="sb-row <?php echo esc_attr($media['media_alignment']); ?>">
            ...
            if (!empty($content)): ?>
               ...
               if (!empty($bages)): ?>
                   <div class="free-badge hero-badge d-flex flex-wrap">
               ...
               <?php endif; ?>
                ...
                ?>
                <ul class="audit-keypoints unstyle d-flex flex-wrap">
                    <?php
