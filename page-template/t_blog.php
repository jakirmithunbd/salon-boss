...
<section class="sb-blog">
    <div class="container">
        <div class="sb-blog-search text-center d-none">
            <h2><?php echo __('Search by Categories', 'sb'); ?></h2>
            <div class="sb-blog-search-form">
                <?php echo get_search_form();?>
            </div>
        </div>
        <div class="sb-blog-tab-buttons d-flex justify-center flex-wrap hide-mobile d-none">
            <?php
        ...
        <div class="sb-blog-tab-select hide-desktop hide-tab text-center d-none">
        ...
        <div class="sb-blog-load-more">
            <button class="sb-button button-bg-green button-icon-phone icon-position-left"><?php echo __('Load More', 'sb');?></button>
        </div>
    </div>
</section><!-- Blog  -->
