                            ...
                            <div class="sb-card-content text-center">
                                ...
                                if ($resource_list_keypoints):
                                    ...
                                    <ul class="unstyle flex-center flex-wrap">
                                        <?php
                                        foreach ($resource_list_keypoints as $keypoint):
                                            ?>
                                ...
                                <div class="sb-card-btn">
                                    <a
                                        href="<?php echo esc_url($resource_list_button['url'] ?? site_url()); ?>"><?php echo esc_attr($resource_list_button['title'] . '>'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- Sb Card  -->
    ...
    <div class="container">
        <div class="sb-content-resource-list d-flex flex-wrap">
            ...
            <div class="sb-content-reource-item">
                ...
                <a class="sb-content-resource-title" href="#">
                    <h3>Ai Assistant For Beauty Professionals</h3>
                </a>
                <p>
                    Salon Boss Ai, is a chatbot assistant that can help
                    you with your online marketing.
                </p>
                <ul>
                    <li>
                        <a href="#">Like ChatGPT But Cheaper & Tailored for
                            Beauty Professionals</a>
                    </li>
                </ul>
